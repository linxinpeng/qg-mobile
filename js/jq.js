...
(function(e, undefined) {
    ...
    function(e, undefined) {
        ...
        c = ot.setDocument = function(e) {
            ...
            g = [],
            d = [],
            (n.qsa = st(t.querySelectorAll)) && (lt(function(e) {
            ...
            y = st(f.contains) || f.compareDocumentPosition ? function(e, t) {
        ...
        i = ot.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[5] && e[2];
                    return J.CHILD.test(e[0]) ? null : (e[3] && e[4] !== undefined ? e[2] = e[4] : n && V.test(n) && (t = vt(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
        ...
        function Ct(e, t, n, r, i, o) {
            ...
            ut(function(o, s, a, u) {
                ...
                if (o) {
                    ...
                    y = Tt(y === s ? y.splice(d, y.length) : y),
    ...
    x.fn.extend({
        data: function(e, t) {
            ...
            if (e === undefined) {
                ...
                1 === i.nodeType && !H.get(i, "hasDataAttrs"))) {
    ...
    x.extend({
        queue: function(e, t, n) {
            ...
            r = H.get(e, t),
            n && (!r || x.isArray(n) ? r = H.access(e, t, x.makeArray(n)) : r.push(n)),
            r || []) : undefined
        },
        ...
        toggleClass: function(e, t) {
            ...
            return x.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n) {
                    ...
                    (n === r || "boolean" === n) && (this.className && H.set(this, "__className__", this.className),
                    this.className = this.className || e === !1 ? "" : H.get(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
            var t = " " + e + " "
    ...
    function qt(e, t) {
        ...
        for (; a > s; s++)
            r = e[s],
            r.style && (o[s] = H.get(r, "olddisplay"),
            n = r.style.display,
            t ? (o[s] || "none" !== n || (r.style.display = ""),
            "" === r.style.display && Lt(r) && (o[s] = H.access(r, "olddisplay", Rt(r.nodeName)))) : o[s] || (i = Lt(r),
            (n && "none" !== n || !i) && H.set(r, "olddisplay", i ? n : x.css(r, "display"))));
        for (s = 0; a > s; s++)
            r = e[s],
